<script setup>
import cameraIconUrl from '../../images/icons8-camera-100.png';
import dashboardIconUrl from '../../images/icons8-gouvernail-de-bateau-80.png';
...
const dashboardMaskStyle = maskStyle(dashboardIconUrl);
const personMaskStyle = maskStyle(personIconUrl);
...
<template>
    ...
    <span
        ...
        :style="dashboardMaskStyle"
        aria-hidden="true"
    />
    <!-- Athlètes / personne -->
    <span
        v-else-if="name === 'users' || name === 'user-circle'"
        :class="['inline-block shrink-0 bg-current opacity-90', props.class]"
        :style="personMaskStyle"
        aria-hidden="true"
    />
    ...
    <span
        ...
        :class="['inline-block shrink-0 bg-current opacity-90', props.class]"
        :style="programsMaskStyle"
        aria-hidden="true"
    />
    <!-- Messagerie (SMS) -->
    <span
        v-else-if="name === 'chat' || name === 'chat-dot'"
        :class="['inline-block shrink-0 bg-current opacity-90', props.class]"
        :style="smsMaskStyle"
        aria-hidden="true"
    />
    ...
    >
        <path
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M2.25 18L9 11.25l4.306 4.307a1.125 1.125 0 001.591 0L21.75 9M21.75 9h-5.25M21.75 9v5.25"
        />
    </svg>
    <!-- Thème clair -->
    <svg
