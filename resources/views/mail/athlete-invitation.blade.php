...
<p style="margin:0 0 16px;"><strong>{{ $coach->name }}</strong> t’a ajouté à son groupe sur Track Coach. Active ton compte pour consulter ton programme, logger tes séances et envoyer tes retours vidéo.</p>
