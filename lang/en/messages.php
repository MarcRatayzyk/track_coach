...
return [
    ...
    'readiness' => [
        ...
        'presets' => [
            ...
            'stress_global' => 'OVERALL STRESS',
            'motivation' => 'MOTIVATION',
            'forme_physique' => 'PHYSICAL FORM',
            'forme_mentale' => 'MENTAL FORM',
        ],
        'options' => [
            'sleep_lt_5' => '< 5H',
            'sleep_5_6' => '5-6H',
            ...
            'average' => 'AVERAGE',
            'good' => 'GOOD',
            'hydration_low' => 'LOW <1.5L',
            'hydration_mid' => 'AVERAGE ~1.5-2L',
            'hydration_good' => 'GOOD ~2L',
            'hydration_excellent' => 'EXCELLENT +2.5L',
            'stress_high' => 'HIGH',
            'stress_mid' => 'MEDIUM',
            'stress_low' => 'LOW',
            'motivation_low' => 'LOW',
            'motivation_mid' => 'AVERAGE',
            'motivation_good' => 'GOOD',
            'motivation_excellent' => 'EXCELLENT',
        ],
    ],
