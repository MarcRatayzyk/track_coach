...
class AppPageController extends Controller
{
    public function dashboard(
        ...
        $onboardingSteps = [
            [
                'key' => 'add_athlete',
                'label' => __('messages.onboarding.add_athlete_label'),
                'description' => __('messages.onboarding.add_athlete_description'),
                'href' => route('athletes.index'),
                'done' => $athleteIds->count() > 0,
            ],
            [
                'key' => 'create_program',
                'label' => __('messages.onboarding.create_program_label'),
                'description' => __('messages.onboarding.create_program_description'),
                'href' => route('program.builder'),
                'done' => $templatesCount > 0,
            ],
            [
                'key' => 'assign_program',
                'label' => __('messages.onboarding.assign_program_label'),
                'description' => __('messages.onboarding.assign_program_description'),
                'href' => route('program.builder'),
                'done' => $activeProgramsCount > 0,
            ],
            [
                'key' => 'reply_feedback',
                'label' => __('messages.onboarding.reply_feedback_label'),
                'description' => __('messages.onboarding.reply_feedback_description'),
