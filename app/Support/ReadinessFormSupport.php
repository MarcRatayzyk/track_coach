...
class ReadinessFormSupport
{
    ...
    public static function presetCatalog(): array
    {
        return [
            [
                'key' => 'steps',
                'label' => __('messages.readiness.presets.steps'),
                'type' => self::TYPE_NUMBER,
            ],
            [
                'key' => 'kcal',
                'label' => __('messages.readiness.presets.kcal'),
                'type' => self::TYPE_TEXT,
            ],
            [
                'key' => 'sommeil',
                'label' => __('messages.readiness.presets.sommeil'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => 'lt_5h', 'label' => __('messages.readiness.options.sleep_lt_5'), 'color' => '#991b1b'],
                    ['value' => '5_6h', 'label' => __('messages.readiness.options.sleep_5_6'), 'color' => '#ea580c'],
                    ['value' => '6_7h', 'label' => __('messages.readiness.options.sleep_6_7'), 'color' => '#ca8a04'],
                    ['value' => '7_8h', 'label' => __('messages.readiness.options.sleep_7_8'), 'color' => '#4ade80'],
                    ['value' => '8_9h', 'label' => __('messages.readiness.options.sleep_8_9'), 'color' => '#7dd3fc'],
                ],
            ],
            [
                'key' => 'alimentation',
                'label' => __('messages.readiness.presets.alimentation'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => 'mauvaise', 'label' => __('messages.readiness.options.bad'), 'color' => '#991b1b'],
                    ['value' => 'moyenne', 'label' => __('messages.readiness.options.average'), 'color' => '#ca8a04'],
                    ['value' => 'bonne', 'label' => __('messages.readiness.options.good'), 'color' => '#4ade80'],
                ],
            ],
            [
                'key' => 'hydratation',
                'label' => __('messages.readiness.presets.hydratation'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => 'faible', 'label' => __('messages.readiness.options.hydration_low'), 'color' => '#991b1b'],
                    ['value' => 'moyenne', 'label' => __('messages.readiness.options.hydration_mid'), 'color' => '#ca8a04'],
                    ['value' => 'bonne', 'label' => __('messages.readiness.options.hydration_good'), 'color' => '#4ade80'],
                    ['value' => 'excellente', 'label' => __('messages.readiness.options.hydration_excellent'), 'color' => '#7dd3fc'],
                ],
            ],
            [
                'key' => 'stress_global',
                'label' => __('messages.readiness.presets.stress_global'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => 'eleve', 'label' => __('messages.readiness.options.stress_high'), 'color' => '#991b1b'],
                    ['value' => 'moyen', 'label' => __('messages.readiness.options.stress_mid'), 'color' => '#4ade80'],
                    ['value' => 'bas', 'label' => __('messages.readiness.options.stress_low'), 'color' => '#7dd3fc'],
                ],
            ],
            [
                'key' => 'motivation',
                'label' => __('messages.readiness.presets.motivation'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => 'faible', 'label' => __('messages.readiness.options.motivation_low'), 'color' => '#991b1b'],
                    ['value' => 'moyenne', 'label' => __('messages.readiness.options.motivation_mid'), 'color' => '#ca8a04'],
                    ['value' => 'bonne', 'label' => __('messages.readiness.options.motivation_good'), 'color' => '#4ade80'],
                    ['value' => 'excellente', 'label' => __('messages.readiness.options.motivation_excellent'), 'color' => '#7dd3fc'],
                ],
            ],
            [
                'key' => 'forme_physique',
                'label' => __('messages.readiness.presets.forme_physique'),
                'type' => self::TYPE_SELECT,
                'options' => [
            ...
            [
                'key' => 'forme_mentale',
                'label' => __('messages.readiness.presets.forme_mentale'),
                'type' => self::TYPE_SELECT,
                'options' => [
                    ['value' => '1', 'label' => '1', 'color' => '#991b1b'],
                    ['value' => '2', 'label' => '2', 'color' => '#ea580c'],
